...
export default function Snippets({
  ...
  return (
    <div>
      ...
      <ul className={cn("grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4", "w-full")}>
                      ...
                      <div className={cn("flex items-center gap-2")}>
                        <ThemeBubble
                          style={{
                            ...
                            "custom"
                              ? (customColors ? JSON.parse(customColors) : find(SUPPORTED_THEMES, "custom").baseColors)
